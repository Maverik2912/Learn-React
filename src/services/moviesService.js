...
export const moviesService = {
    ...
    getByGenreId: (genreId) => apiMoviesService.get(urls.moviesList, {params: {sort_by: 'popularity.desc', with_genres: genreId}}),
    getByTimeInterval: (from, to) => apiMoviesService.get(urls.moviesList, {params: {'primary_release_date.gte': from, 'primary_release_date.lte': to, sort_by: 'popularity.desc'}}),
